...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count): #
        ...
        nearby_cells -= self.safes | self.moves_made
        self.knowledge.append(Sentence(nearby_cells, count))

        # 4) mark any additional cells as safe or as mines if it can be concluded based on the AI's knowledge base
        ## Find cells that are safe or mine
        new_mines = set()
        new_safes = set()
        for sentence in self.knowledge:
        ...
        ## New cells are marked as safe or mine
    ...
    def make_safe_move(self): #
        ...
        return random.choice(tuple(safe_moves)) if safe_moves else None
    ...
    def make_random_move(self): #
        ...
        """
        safe_moves = set(itertools.product(range(0, self.height), range(0, self.width))) - self.mines - self.moves_made
